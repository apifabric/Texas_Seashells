...
resourcename="texasseashells"  # lower case, only
resourcegroup="texasseashells_rg"
...
# git clone https://github.com/apilogicserver/texasseashells.git
# cd texasseashells
...
az group create --name texasseashells_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group texasseashells_rg --sku S1 --is-linux
az container create --resource-group texasseashells_rg --name texasseashells --image apilogicserver/texasseashells:latest --dns-name-label texasseashells --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//texasseashells.westus.azurecontainer.io:5656'
