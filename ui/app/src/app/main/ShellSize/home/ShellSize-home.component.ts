...
@Component({
  selector: 'ShellSize-home',
  templateUrl: './ShellSize-home.component.html',
  styleUrls: ['./ShellSize-home.component.scss']
})
export class ShellSizeHomeComponent implements AfterViewInit {
