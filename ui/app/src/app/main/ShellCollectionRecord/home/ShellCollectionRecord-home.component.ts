...
@Component({
  selector: 'ShellCollectionRecord-home',
  templateUrl: './ShellCollectionRecord-home.component.html',
  styleUrls: ['./ShellCollectionRecord-home.component.scss']
})
export class ShellCollectionRecordHomeComponent implements AfterViewInit {
