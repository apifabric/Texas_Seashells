...
@Component({
  selector: 'ShellLocation-home',
  templateUrl: './ShellLocation-home.component.html',
  styleUrls: ['./ShellLocation-home.component.scss']
})
export class ShellLocationHomeComponent implements AfterViewInit {
