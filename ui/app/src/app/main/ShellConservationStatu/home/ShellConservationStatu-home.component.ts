...
@Component({
  selector: 'ShellConservationStatu-home',
  templateUrl: './ShellConservationStatu-home.component.html',
  styleUrls: ['./ShellConservationStatu-home.component.scss']
})
export class ShellConservationStatuHomeComponent implements AfterViewInit {
