...
@Component({
  selector: 'ShellCollectionTime-home',
  templateUrl: './ShellCollectionTime-home.component.html',
  styleUrls: ['./ShellCollectionTime-home.component.scss']
})
export class ShellCollectionTimeHomeComponent implements AfterViewInit {
