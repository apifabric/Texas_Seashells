...
@Component({
  selector: 'ShellScientificStudy-home',
  templateUrl: './ShellScientificStudy-home.component.html',
  styleUrls: ['./ShellScientificStudy-home.component.scss']
})
export class ShellScientificStudyHomeComponent implements AfterViewInit {
