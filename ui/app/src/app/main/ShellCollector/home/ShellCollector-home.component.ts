...
@Component({
  selector: 'ShellCollector-home',
  templateUrl: './ShellCollector-home.component.html',
  styleUrls: ['./ShellCollector-home.component.scss']
})
export class ShellCollectorHomeComponent implements AfterViewInit {
