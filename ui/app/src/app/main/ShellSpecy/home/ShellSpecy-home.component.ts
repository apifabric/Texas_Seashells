...
@Component({
  selector: 'ShellSpecy-home',
  templateUrl: './ShellSpecy-home.component.html',
  styleUrls: ['./ShellSpecy-home.component.scss']
})
export class ShellSpecyHomeComponent implements AfterViewInit {
