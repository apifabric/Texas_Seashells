...
@Component({
  selector: 'ShellPhoto-home',
  templateUrl: './ShellPhoto-home.component.html',
  styleUrls: ['./ShellPhoto-home.component.scss']
})
export class ShellPhotoHomeComponent implements AfterViewInit {
