...
@Component({
  selector: 'ShellHistoricalUse-home',
  templateUrl: './ShellHistoricalUse-home.component.html',
  styleUrls: ['./ShellHistoricalUse-home.component.scss']
})
export class ShellHistoricalUseHomeComponent implements AfterViewInit {
