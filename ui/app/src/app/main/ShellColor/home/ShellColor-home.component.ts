...
@Component({
  selector: 'ShellColor-home',
  templateUrl: './ShellColor-home.component.html',
  styleUrls: ['./ShellColor-home.component.scss']
})
export class ShellColorHomeComponent implements AfterViewInit {
